...
class PawDrawDocument extends Disposable implements vscode.CustomDocument {
    ...
    async save(cancellation: vscode.CancellationToken): Promise<void> {
        ...
        vscode.window.showInformationMessage('Association-viewer now is readonly! Nothing to do.');
    }
 ...
 */
export class AssocViewerProvider implements vscode.CustomEditorProvider<PawDrawDocument> {
    ...
    public static register(context: vscode.ExtensionContext): vscode.Disposable {
        ...
        //     const uri = vscode.Uri.joinPath(workspaceFolders[0].uri, `new-${AssocViewerProvider.newPawDrawFileId++}.pawdraw`)
        //         .with({ scheme: 'untitled' });

        //     vscode.commands.executeCommand('vscode.openWith', uri, AssocViewerProvider.viewType);
        // });

        return vscode.window.registerCustomEditorProvider(
            AssocViewerProvider.viewType,
            new AssocViewerProvider(context),
            {
    ...
    private static readonly viewType = 'assocCustoms.viewAssoc';
